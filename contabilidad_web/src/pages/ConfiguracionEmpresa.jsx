...
import { Settings, Plus, Trash2, Save, AlertTriangle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="p-8 pb-32 max-w-5xl mx-auto">
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500">Administra los parámetros contables y mapeos financieros</p>
        </div>
      </div>
      ...
      {/* Módulo: Mapeo de Flujo de Efectivo */}
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
        <div className="p-6 border-b border-slate-100 bg-slate-50">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Asigna qué prefijos de tu Catálogo de Cuentas (Balance General) corresponden a las actividades de Operación, Inversión o Financiación.
            El sistema requiere este mapeo para armar automáticamente el Método Indirecto NIIF.
          </p>
        </div>
